...
//   const sections = [
//     { id: "qrCode", ref: qrRef, icon: <QrCode className="text-[#7B53A6]" />, label: "QR Code Generation" },
...
//     { id: "cloudBackup", ref: cloudRef, icon: <Cloud className="text-[#7B53A6]" />, label: "Cloud Backup" },
//   ];

//   const [activeSection, setActiveSection] = useState<string>("qrCode");
...
export default function OtherServicesManage() {
  ...
  const [activeSection, setActiveSection] = useState<string>("qr");
