      ...
      <div className="space-y-4">
              ...
              <CardContent>
                ...
                <div className="mb-3 flex items-center justify-between">
                  <div className="text-sm">
                    <button className="text-sm text-violet-600" onClick={() => toggleSelectAll(true)}>Select all</button>
                    <button className="ml-2 text-sm text-gray-500" onClick={() => toggleSelectAll(false)}>Clear</button>
                  </div>
                  <div>
        ...
        {previewOpen && typeof document !== 'undefined' && createPortal(
          <div className="fixed inset-0 z-[9999] flex items-center justify-center px-4">
            ...
            <div className="relative bg-white rounded-lg shadow-xl w-full max-w-2xl mx-auto overflow-visible z-50">
              <div className="flex items-center justify-between px-6 py-4 border-b">
                <h3 className="text-lg font-semibold">Preview Notification</h3>
                <div className="flex items-center gap-3">
                  <button className="text-sm text-gray-500" onClick={() => setPreviewOpen(false)}>Close</button>
                </div>
              </div>
              <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-2">
                  <div className="text-sm text-gray-500 mb-2">Subject</div>
                  <div className="mb-4 font-medium">{subject || '(No subject)'}</div>

                  <div className="text-sm text-gray-500 mb-2">Message</div>
                  <div className="whitespace-pre-wrap bg-gray-50 p-4 rounded mb-3">{message || '(No message)'}</div>
