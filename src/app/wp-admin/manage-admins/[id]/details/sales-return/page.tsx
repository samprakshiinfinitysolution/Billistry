        ...
        <div>
          ...
          <div className="mb-4 grid grid-cols-1 md:grid-cols-6 gap-2">
            ...
            <div>
              ...
              <Select value={customerSelect} onValueChange={(v) => setCustomerSelect(v)}>
            ...
            <div>
              ...
              <Input placeholder="Search return, customer, product..." value={searchQuery} onChange={e => setSearchQuery((e.target as HTMLInputElement).value)} className="mt-1" />
            </div>
            <div>
          ...
          <div className="flex gap-2 mb-4">
            <Button variant="ghost" size="sm" onClick={() => { setStartDate(''); setEndDate(''); setCustomerSelect('all'); setPaymentStatusFilter('all'); setMinAmount(''); setMaxAmount(''); setProductSelect('all'); setSearchQuery(''); }}>Clear</Button>
          </div>
