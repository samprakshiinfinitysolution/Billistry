        ...
        <div>
          ...
          <div className="mb-4 grid grid-cols-1 md:grid-cols-6 gap-2">
            ...
            <div>
              ...
              <input placeholder="Search bill, supplier, product..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="mt-1 block w-full border rounded px-2 py-1" />
            </div>
            <div>
