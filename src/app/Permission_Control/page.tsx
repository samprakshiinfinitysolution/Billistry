...
export default function UserRoleManagement() {
  const userAccountsRef = useRef<HTMLDivElement>(null) as RefObject<HTMLDivElement>;
  const permissionRef = useRef<HTMLDivElement>(null) as RefObject<HTMLDivElement>;
  ...
  const [activeSection, setActiveSection] = useState<string>("permissionControl");
...
function Section({ id, ref, title, items }: any) {
  return (
    <section id={id} ref={ref} className="scroll-mt-23 md:scroll-mt-35">
