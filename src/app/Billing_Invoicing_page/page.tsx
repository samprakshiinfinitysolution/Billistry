...
// export default function BillingInvoicingServices() {
...
//   const sections = [
//     { id: "invoice", ref: invoiceRef, icon: <FileText />, label: "Invoice Generation" },
//     { id: "billing", ref: billingRef, icon: <CreditCard />, label: "Billing" },
//     { id: "notes", ref: notesRef, icon: <Undo2 />, label: "Credit & Debit Notes" },
//     { id: "payment", ref: paymentRef, icon: <DollarSign />, label: "Payment Tracking" },
//   ];

//   const [activeSection, setActiveSection] = useState<string>("invoice");
...
//           const activeEl = document.getElementById(`tab-${visible.target.id}`);
...
//     <div className="grid md:grid-cols-12 gap-8 scroll-mt-500">
//       {/* Sidebar */}
...
export default function BillingInvoicing() {
  ...
  const billingRef = useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>;
  const notesRef = useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>;
  const paymentRef = useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>;
    ...
    <div className="font-poppins bg-[#F7FBFB] sm:px-8 lg:px-10 ">
      ...
      <div className="container mx-auto px-4 py-8 grid md:grid-cols-12 gap-8">
        ...
        <div className="hidden md:block md:col-span-4">
          <div className="sticky top-35 md:sticky md:top-18 space-y-6">
            {/* Back Button */}
...
function Section({ id, ref, title, items }: any) {
  return (
    <section id={id} ref={ref} className="scroll-mt-75 md:scroll-mt-30">
