...
//   state?: string;
=======
//   state?: string; // optional if you want auto CGST/SGST vs IGST
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
// }
// interface Item {
//   _id: string;
...
//   gstApplied?: boolean;
=======
//   gstApplied?: boolean; // make it optional-safe for older records
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
// }
// interface Sale {
//   _id: string;
...
<<<<<<< HEAD
=======
// // Basic amount-in-words (Indian style; lakhs/crores kept simple)
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
//   // --- Editable Company (you can preload from /api/company if you have one) ---
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
=======
//     state: "Karnataka", // used for CGST/SGST vs IGST
//   });

//   // --- Invoice Editable Data ---
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
<<<<<<< HEAD
=======
//   // For intra-state toggle (CGST/SGST) vs IGST
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
//       try {
//         const res = await axios.get(`/api/sale/${saleId}`);
//         const s: Sale = res.data;
//         // Ensure fallback fields for older data:
//         const items = (s.items || []).map((ln) => ({
//           ...ln,
//           gstApplied: ln.gstApplied ?? true, // default true if item has GST
//         }));
//         setSale({ ...s, items });

//         // If you can compare company.state vs customer.state, set intraState:
//         const customerState = s.billTo?.state || company.state;
//         setIntraState(
...
//   const updateBillTo = (fields: Partial<Customer>) =>
//     setSale((prev) =>
//       prev ? { ...prev, billTo: { ...prev.billTo, ...fields } } : prev
//     );
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
//   const updateItem = (
//     idx: number,
//     fields: Partial<SaleLine> & { item?: Partial<Item> }
//   ) =>
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
//     setSale((prev) => {
//       if (!prev) return prev;
...
=======
//   const updateMeta = (fields: Partial<Sale>) =>
//     setSale((p) => (p ? { ...p, ...fields } : p));

//   // --- Totals ---
//   const totals = useMemo(() => {
//     if (!sale)
//       return { subTotal: 0, gst: 0, cgst: 0, sgst: 0, igst: 0, grandTotal: 0 };
...
//         signature,
=======
//         // Keep notes & signature if your API stores them:
//         notes,
//         signature,
//         // Optional: persist if intra/igst is needed in backend
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
=======
//     if (sale.billTo?.mobile)
//       doc.text(`Mobile: ${sale.billTo.mobile}`, marginX, y);
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
=======
//       head: [
//         ["#", "Item", "HSN", "Qty", "Rate", "Taxable", "GST %", "GST Amt"],
//       ],
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
//       body,
...
=======
//     doc.text(
//       `${company.bank.accountName} • ${company.bank.name} • A/C: ${company.bank.accountNo} • IFSC: ${company.bank.ifsc}`,
//       marginX,
//       y2
//     );
//     y2 += 12;
...
//   // ✅ UseRef inside the component, don't put it outside
...
//           {saving ? "Saving…" : "Save"}
//         </button>
//         <button className="px-3 py-2 border rounded" onClick={reactToPrintFn}>
//           Print
//         </button>
//         <button className="px-3 py-2 border rounded" onClick={exportPDF}>
//           Download PDF
//         </button>
//         <button className="px-3 py-2 border rounded" onClick={exportExcel}>
//           Export Excel
//         </button>
//         <label className="flex items-center gap-2 ml-4">
//           <input
...
//       <div
//         ref={contentRef}
//         className="bg-white shadow rounded-lg p-6 print:shadow-none print:rounded-none print:p-4 "
//       >
//         {/* Header */}
//         <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 border-b pb-4">
//           <div>
...
//             />
//             <textarea
//               className="block text-sm text-gray-700 mt-1 outline-none w-full resize-y"
...
//                   value={format(new Date(sale.date), "yyyy-MM-dd")}
...
//                   onChange={(e) =>
//                     updateMeta({
//                       paymentStatus: e.target.value as Sale["paymentStatus"],
//                     })
//                   }
//                 >
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
//                   setCompany({
//                     ...company,
//                     bank: { ...company.bank, name: e.target.value },
//                   })
//                 }
//               />
//               <input
...
//                   setCompany({
//                     ...company,
//                     bank: { ...company.bank, accountName: e.target.value },
//                   })
//                 }
//               />
//               <input
...
//                 value={company.bank.accountNo}
//                 onChange={(e) =>
//                   setCompany({
//                     ...company,
//                     bank: { ...company.bank, accountNo: e.target.value },
//                   })
//                 }
//               />
//               <input
...
//                   setCompany({
//                     ...company,
//                     bank: { ...company.bank, ifsc: e.target.value },
//                   })
//                 }
//               />
//               <input
...
//                 placeholder="UPI ID"
//                 value={company.bank.upi}
//                 onChange={(e) =>
//                   setCompany({
//                     ...company,
//                     bank: { ...company.bank, upi: e.target.value },
//                   })
//                 }
//               />
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
//                   <th className="border px-2 py-2 text-right">Qty</th>
//                   {/* <th className="border px-2 py-2 text-right">UQC</th> */}
//                   <th className="border px-2 py-2 text-right">Price</th>
//                   {/* <th className="border px-2 py-2 text-right">Disc</th>
//                   <th className="border px-2 py-2 text-right">CDC</th> */}
//                   {/* <th className="border px-2 py-2 text-right">Price With GST</th> */}
//                   <th className="border px-2 py-2 text-right">Taxable Rate</th>
//                   <th className="border px-2 py-2 text-right">GST %</th>
//                   {/* <th className="border px-2 py-2 text-right">Amount</th> */}
//                   <th className="border px-2 py-2 text-center print:hidden">
//                     GST?
//                   </th>
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
...
//                   const gstRate = ln.gstApplied ? Number(ln.item?.gstRate || 0) : 0;
=======
//                   const gstRate = ln.gstApplied
//                     ? Number(ln.item?.gstRate || 0)
//                     : 0;
...
//                           value={ln.item?.hsn || ""}
//                           onChange={(e) =>
//                             updateItem(i, { item: { hsn: e.target.value } })
//                           }
//                         />
//                       </td>
//                       <td className="border px-2 py-2 text-right">
...
//                           value={ln.item?.gstRate || 0}
//                           onChange={(e) =>
//                             updateItem(i, {
//                               item: { gstRate: Number(e.target.value) },
//                             })
//                           }
//                         />
//                       </td>
...
//                         <input
//                           type="checkbox"
//                           checked={!!ln.gstApplied}
//                           onChange={(e) =>
//                             updateItem(i, { gstApplied: e.target.checked })
//                           }
//                         />
//                       </td>
//                       <td className="border px-2 py-2 text-center print:hidden">
...
//               placeholder="Any terms or special notes…"
//             />
//           </div>
//           <div className="border rounded p-3">
//             <div className="flex justify-between text-sm">
...
//                   <div>CGST</div>
//                   <div>₹ {inr(totals.cgst)}</div>
//                 </div>
//                 <div className="flex justify-between text-sm mt-1">
//                   <div>SGST</div>
//                   <div>₹ {inr(totals.sgst)}</div>
//                 </div>
//               </>
//             ) : (
//               <div className="flex justify-between text-sm mt-1">
//                 <div>IGST</div>
//                 <div>₹ {inr(totals.igst)}</div>
//               </div>
//             )}
//             <div className="flex justify-between mt-2 font-semibold text-lg">
//               <div>Grand Total</div>
...
//             <div className="text-xs text-gray-600 mt-2">
//               Amount in words:{" "}
//               <span className="italic">{amountInWords(totals.grandTotal)}</span>
//             </div>
//           </div>
>>>>>>> dcc59acd5f59524ac9f5cc4448fa122e42a677b1
//         </div>
...
=======
//             <div>
//               For <span className="font-semibold">{company.name}</span>
//             </div>
//             <div className="h-14" />
//             <input
//               className="border-b outline-none text-sm text-right"
//               value={signature}
