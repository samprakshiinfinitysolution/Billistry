...
const CreatePurchaseReturnInvoicePage = () => {
    ...
    useEffect(() => {
        // If the user clears the LinkToInvoice input, unlock the form
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                            <Button variant="outline" onClick={() => setIsSettingsOpen(true)} className="bg-white border-gray-200 text-gray-700 hover:bg-gray-50 px-3 py-1.5 rounded-md shadow-sm cursor-pointer">
                            ...
                            }} className="bg-indigo-600 text-white font-semibold cursor-pointer hover:bg-indigo-700 px-4 py-2">
