    ...
    try {
      const res = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          name,
          email,
          subject: `Feedback Submission: ${rating} Stars`,
          message: feedback,
        }),
      });
          ...
          <div className="p-8 text-left">
            <form onSubmit={handleSubmit} className="space-y-6 text-gray-600" >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-[#460F58]  cursor-pointer text-white rounded-xl font-semibold text-lg shadow-md hover:bg-[#390F59] transition transform hover:scale-105 disabled:opacity-70 disabled:cursor-not-allowed"
              >
