...
//   const sections = [
//     { id: "Product Management", ref: productRef, icon: <Package className="text-[#7B53A6]" />, label: "Product Management" },
//     { id: "Stock Tracking", ref: stockRef, icon: <BarChart3 className="text-[#7B53A6]" />, label: "Stock Tracking" },
//     { id: "Warehouse Management", ref: warehouseRef, icon: <Boxes className="text-[#7B53A6]" />, label: "Warehouse Management" },
//     { id: "Supplier Management", ref: supplierRef, icon: <Truck className="text-[#7B53A6]" />, label: "Supplier Management" },
//   ];

//   const [activeSection, setActiveSection] = useState<string>("Product Management");
