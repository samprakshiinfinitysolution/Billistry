...
//   const sections = [
//     { id: "sales", ref: salesRef, icon: <ShoppingCart className="text-[#7B53A6]" />, label: "Sales Management" },
//     { id: "purchase", ref: purchaseRef, icon: <CreditCard className="text-[#7B53A6]" />, label: "Purchase Management" },
//     { id: "returns", ref: returnRef, icon: <Undo2 className="text-[#7B53A6]" />, label: "Return Management" },
//   ];
...
function Section({ id, ref, title, items }: any) {
  return (
    <section id={id} ref={ref} className="scroll-mt-65 md:scroll-mt-35">
