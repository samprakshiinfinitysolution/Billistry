...
//   return (
//     <section className="bg-[#F9FAFB] py-20 px-9 font-['Poppins']">
//       <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-12">
        
//         {/* Left: FAQ Form */}
//         <div className="lg:w-1/3 w-full  bg-gradient-to-br from-white to-indigo-50 rounded-3xl p-10 shadow-lg hover:shadow-xl transition-all">
//           <h2 className="text-4xl font-extrabold text-[#3B3D72] mb-6">Ask a Question</h2>
...
//               className="w-full px-5 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-400 focus:outline-none transition"
//               required
//             />
//             <input
//               type="email"
...
//               onChange={handleChange}
//               rows={4}
//               className="w-full px-5 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-400 focus:outline-none resize-none transition"
//               required
//             />
//             <button
//               type="submit"
//               className="w-full py-3 rounded-full bg-gradient-to-r from-[#3B3D72] to-[#6C63FF] text-white font-semibold text-lg hover:bg-indigo-700 shadow-md transition"
//             >
//               Submit Question
//             </button> 
//           </form>
...
//     <div
//       key={i}
//       className={`relative bg-white mt-2 rounded-3xl shadow-md p-4 sm:p-4 cursor-pointer flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5 border hover:shadow-xl hover:border-indigo-500 hover:-translate-y-1 transition-all duration-300`}
//       onClick={() => setOpen(open === i ? null : i)}
//     >
//       {/* Icon */}
//       <div className="flex-shrink-0 w-12 h-12 sm:w-9 sm:h-9 bg-indigo-100 rounded-full flex items-center justify-center shadow-sm">
...
//           <h3 className="text-lg sm:text-base font-semibold text-[#1E1E2F] hover:text-indigo-700 transition-colors duration-300">
//             {f.q}
//           </h3>
//           <ChevronDown
//             className={`w-6 h-6 text-indigo-400 transition-transform duration-300 ${open === i ? 'rotate-180' : ''}`}
//           />
//         </div>
//         <p
//           className={`text-gray-600 mt-2 text-sm overflow-hidden transition-all duration-500 ${open === i ? 'max-h-40' : 'max-h-0'}`}
//         >
//           {f.a}
//         </p>
//       </div>
