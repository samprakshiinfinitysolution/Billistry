...
//     try {
//       const url = search ? `/api/category?q=${encodeURIComponent(search)}` : "/api/category";
...
//       const data = await res.json();
//       if (data.success) {
//         const created = Array.isArray(data.categories) ? data.categories[0] : data.categories;
...
//           <div className="relative w-full cursor-default overflow-hidden rounded-lg border bg-white text-left shadow-md focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm">
//             <Combobox.Input
...
//               {/* ✅ Always show Add Category button at the bottom */}
